    ...
    <main>
        <div class="mx-auto mt-8 max-w-7xl py-6 sm:px-6 lg:px-8 bg-white rounded-md shadow">
            <form method="POST" action="/note">
                <input type="hidden" name="_req_method" value="PATCH" />
                <input type="hidden" name="id" value="<?= $note['idnotes'] ?>" />                
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8">
                    <div class="col-span-full">
                        <label for="body" class="block text-sm/6 font-medium text-white dark:text-black">Edit note</label>
                        <div class="mt-2">
                            <textarea 
                                id="body" 
                                name="body" 
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <a href="/notes" class="text-gray-500">Cancel</a>
